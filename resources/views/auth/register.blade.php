...
<head>
    ...
    <title>Daftar - Klinik Mon Cheri</title>
...
<body class="font-[Inter] bg-gray-50">
    <div class="min-h-screen flex flex-col items-center justify-center py-12 px-4">
        ...
        <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8" style="border-top: 4px solid #FFB6C1;">
            ...
            <p class="text-gray-500 mb-6">Isi data diri Anda untuk mendaftar</p>
            ...
            <p class="text-center text-gray-500 mt-6">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="font-semibold hover:underline" style="color: #D4AF37;">Login</a>
            </p>
        </div>
    </div>
</body>
