...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - Klinik Mon Cheri</title>
    ...
    <style>
        ...
        * {
        ...
        .sidebar-link.active {
            ...
            color: #fff;
            box-shadow: inset 3px 0 0 #FFB6C1;
        }
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.doctors') }}" class="sidebar-link {{ request()->routeIs('admin.doctors*') ? 'active' : '' }}">
                ...
                <span class="sidebar-link-text">Dokter</span>
                <span class="sidebar-link-arrow">→</span>
            </a>
            ...
            <a href="{{ route('admin.services') }}" class="sidebar-link {{ request()->routeIs('admin.services*') ? 'active' : '' }}">
                ...
                <span class="sidebar-link-text">Layanan</span>
                <span class="sidebar-link-arrow">→</span>
            </a>

            <a href="{{ route('admin.schedules') }}" class="sidebar-link {{ request()->routeIs('admin.schedules*') ? 'active' : '' }}">
                <div class="sidebar-link-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <span class="sidebar-link-text">Jadwal</span>
                <span class="sidebar-link-arrow">→</span>
            </a>
            ...
            <a href="{{ route('admin.articles') }}" class="sidebar-link {{ request()->routeIs('admin.articles*') ? 'active' : '' }}">
                ...
                <span class="sidebar-link-text">Artikel</span>
                <span class="sidebar-link-arrow">→</span>
            </a>
        </nav>
        ...
        <header class="admin-topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-breadcrumb">
                    <span>@yield('breadcrumb', 'Admin Panel')</span>
                </div>
            </div>
            ...
            <div class="topbar-right">
                <div class="topbar-user-dropdown">
                    <button class="topbar-user-btn" onclick="toggleUserDropdown()" aria-expanded="false" id="userDropdownBtn">
                        ...
                        <svg class="topbar-user-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                    </button>
