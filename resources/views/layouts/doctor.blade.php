...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .section-header-icon.pink { background: #fce7f3; color: #db2777; }
        .section-header-icon.blue { background: #DBEAFE; color: #2563EB; }
        .section-header-icon.gold { background: #fef9c3; color: #a16207; }
...
<body>
    ...
    <aside class="role-sidebar" id="roleSidebar">
        ...
        <nav class="sidebar-nav" aria-label="Menu dokter">
