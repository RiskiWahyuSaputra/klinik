...
<head>
    ...
    <title>@yield('title', 'Dashboard Dokter') - Klinik Mon Cheri</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .topbar-hamburger {
            ...
            border: none; background: #f4f5f9; border-radius: 10px;
            cursor: pointer; align-items: center; justify-content: center;
            transition: all 0.2s ease; color: #4a4a6a;
        }
        ...
        .topbar-btn {
            ...
            transition: all 0.2s ease; color: #4a4a6a; position: relative;
        }
        .topbar-btn:hover { background: #e8e9f0; transform: translateY(-1px); }

        .topbar-user-dropdown { position: relative; }

        .topbar-user-btn {
            display: flex; align-items: center; gap: 10px;
            padding: 4px 12px 4px 4px; border: none;
            background: #f4f5f9; border-radius: 10px;
        ...
        .dropdown-menu {
            ...
            transition: all 0.2s ease; z-index: 200; border: 1px solid #eef0f5;
        }
        ...
        .dropdown-item {
            ...
            color: #4a4a6a; text-decoration: none; font-size: 13px; font-weight: 500;
        ...
        .admin-table thead th {
            ...
            letter-spacing: 0.5px; color: #8e8ea0;
            background: #fafbfc; border-bottom: 1px solid #eef0f5;
        }
        ...
        .btn-secondary {
            display: inline-flex; align-items: center; gap: 8px;
            padding: 10px 22px; border: 1px solid #e2e4ea; border-radius: 12px;
            font-size: 13px; font-weight: 600; cursor: pointer;
            transition: all 0.2s ease; background: #fff; color: #4a4a6a; text-decoration: none;
        }
        ...
        .btn-warning:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(212, 175, 55, 0.35); }

        .btn-sm { padding: 6px 14px; font-size: 12px; border-radius: 8px; }

        .form-input {
            width: 100%; padding: 11px 16px;
            border: 1px solid #e2e4ea; border-radius: 12px;
            font-size: 14px; color: #2d2d44; background: #fff;
            outline: none; transition: all 0.2s ease; font-family: 'Poppins', sans-serif;
        }
        ...
        .pagination-wrap a, .pagination-wrap span {
            ...
            font-size: 13px; font-weight: 500; color: #4a4a6a;
        ...
        @media (max-width: 1024px) {
            .role-content { padding: 24px 20px; }
        ...
        @media (max-width: 768px) {
            ...
            .admin-table tbody td {
                display: flex; justify-content: space-between; align-items: center;
                padding: 8px 0; border: none; font-size: 13px;
            }
            .admin-table tbody td::before {
                content: attr(data-label);
                font-weight: 600; color: #8e8ea0;
        ...
        @media (max-width: 480px) {
            .role-content { padding: 16px 12px; }
...
<body>
    ...
    <aside class="role-sidebar" id="roleSidebar">
        <div class="sidebar-brand">
            <a href="{{ route('doctor.dashboard') }}" class="sidebar-brand-link">
                <div class="sidebar-brand-icon">M</div>
                <div class="sidebar-brand-text">
                    <span class="sidebar-brand-name">Mon Cheri</span>
                    <span class="sidebar-brand-sub">Dokter Panel</span>
                </div>
            </a>
        </div>

        <nav class="sidebar-nav">
            <div class="sidebar-label">Menu Dokter</div>
        ...
        <div class="sidebar-footer">
            <div class="sidebar-user" onclick="toggleDropdown()" id="sidebarUserBtn">
                ...
                <div class="sidebar-user-info">
                    ...
                    <div class="sidebar-user-role">Dokter</div>
                </div>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: rgba(255,255,255,0.3); flex-shrink: 0;">
    ...
    <div class="role-main">
        <header class="role-topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-breadcrumb"><span>@yield('breadcrumb', 'Dashboard Dokter')</span></div>
            </div>
